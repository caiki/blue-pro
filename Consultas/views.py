...
def listado_reportes_view(request):
	return render('ListadoReportes.html',context_instance=RequestContext(request))
...
def listado_gastos_reporte_mes_view(request):
	return render('reporteGastos.html',context_instance=RequestContext(request))


@login_required
def listado_creditos_reporte_mes_view(request):
	return render('reporteCreditos.html',context_instance=RequestContext(request))
...
def listado_tarjeta_reporte_mes_view(request):
	return render('reporteTarjetas.html',context_instance=RequestContext(request))
...
def listado_Descuento_reporte_mes_view(request):
	return render('reporteDescuentos.html',context_instance=RequestContext(request))
...
def listado_Pago_reporte_mes_view(request):
	return render('reportePagos.html',context_instance=RequestContext(request))
